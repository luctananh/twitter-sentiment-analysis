...
def train_and_evaluate(tweets, vectorizer_type='tfidf', model_type='logistic_regression', model_path="../models/TFIDF_LogisticRegression_model.sav", C=1.0): # Thay đổi đường dẫn model
...
def load_model(model_path="../models/TFIDF_LogisticRegression_model.sav"): # Thay đổi đường dẫn model
