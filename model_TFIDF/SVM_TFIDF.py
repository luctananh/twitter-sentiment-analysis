...
def train_and_evaluate(tweets, vectorizer_type='tfidf', model_type='svm', model_path="../models/TFIDF_SVM_model.sav", C=1.0): 
...
def load_model(model_path="../models/TFIDF_SVM_model.sav"): 
   try:
